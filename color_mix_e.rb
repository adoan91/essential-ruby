...
def mix_color(color1, color2)
	if (color1 == "red" or color1 == "blue") and (color2 == "blue" and color2 == "red")
		new_color = "purple"
	elsif(color1 == "red" or color1 == "yellow") and (color2 == "yellow" and color2 == "red")
		new_color = "orange"
	elsif (color1 == "yellow" or color1 == "blue") and (color2 == "blue" and color2 == "yellow")
		new_color = "green"
	else
